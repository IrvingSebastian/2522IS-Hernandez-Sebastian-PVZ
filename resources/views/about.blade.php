    ...
    <div class="container">
      ...
      <nav class="navbar-fullscreen" id="navbar-middle">
        ...
        <ul class="navbar-fullscreen-links">
          <li><a href="./index.blade.php" title="">Home</a></li>
          <li><a href="./project.blade.php" title="">Project</a></li>
          <li><a href="./about.blade.php" title="">About me</a></li>
          <li><a href="./components.blade.php" title="">Components</a></li>
        </ul>
...
<div class="section-container content-container">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="col-md-6">
                    <img src="./images/img-profil.jpg" class="img-responsive" alt=""> 
                </div>
                <div class="col-md-6">
