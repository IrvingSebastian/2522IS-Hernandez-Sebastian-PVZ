    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="col-md-6">
                    <h1 class="h2">Irving Gregorio Sebastián Ildefonso (IrvinGreg)</h1>
                    <p>Hola, soy Irving, me fascina la Tecnología en general, es por ello que decidí 
                        estudiar programación y sigo haciendolo actualmente.</p>
        ...
        <iframe style="align-items: center" src="https://discord.com/widget?id=858003129064751114&theme=dark" width="350" height="500" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
    </div>
</div>
@endsection