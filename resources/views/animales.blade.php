...
@section('Cuerpo')
<div class="hero-full-container background-image-container white-text-container" style="background-image:url('./img/img-08.jpg')">
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        ...
        <img src="./img/img-03.jpg" alt="" class="img-responsive">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
            <img src="./img/img-01.jpg" class="img-responsive" alt="">
            <p>Artefact Buildging</p>
            </div>
        </div>

        <img src="./img/img-04.jpg" class="img-responsive" alt="">
        <p>Menphis skyline</p>
